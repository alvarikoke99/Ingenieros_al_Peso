...
# Solicitud
INSERT INTO `web`.`solicitud`(`tipo`,`fecha_ini`,`fecha_final`,`tramitada`,`id_trabajador`)VALUES('Dias libres','2020-01-23','2020-02-01',0,1);
INSERT INTO `web`.`solicitud`(`tipo`,`fecha_ini`,`fecha_final`,`tramitada`,`id_trabajador`)VALUES('Vacaciones','2020-03-01','2020-04-01',0,2);
INSERT INTO `web`.`solicitud`(`tipo`,`fecha_ini`,`fecha_final`,`tramitada`,`id_trabajador`)VALUES('Medico-ginecologo','2020-01-2','2020-01-3',0,3);

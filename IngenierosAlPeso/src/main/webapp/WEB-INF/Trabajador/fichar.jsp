...
<html lang="es">
    ...
    <body>
        ...
        <div class="topnav" id="topnav">
            ...
            <a class="enlace" href="solicitarVacaciones.html">Solicitar días libres</a>
            <a class="enlace" href="misProyectos.html">Mis proyectos</a>
            <a class="enlace" href="misDatos.html">Mis datos</a>
        ...
        <div class="contentCenter">
            <form method="POST" action="JornadaController?action=fichar">
